...
use WPCleanFix\WPBones\Database\Support\Collection;
use WPCleanFix\WPBones\Database\Support\Model;
...
class QueryBuilder
{
   ...
   *
   * @var \WPCleanFix\WPBones\Database\Support\Collection
   */
  private $collection = [];
  ...
  */
   ...
   * @return \WPCleanFix\WPBones\Database\QueryBuilder
   */

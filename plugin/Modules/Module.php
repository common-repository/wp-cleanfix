...
abstract class Module
{
    ...
    <div class="wp-cleanfix-toolbar">
      <div class="wp-cleanfix-refresh-all alignleft">
        <button class="button button-secondary">
          <span class="dashicons dashicons-update"></span> <?php esc_attr_e(
            'Refresh all',
            'wp-cleanfix'
          ); ?>
        </button>
      ...
      <div class="wp-cleanfix-fix-all alignright">
        <button class="button button-primary">
          <span class="dashicons dashicons-editor-removeformatting"></span> <?php esc_attr_e(
            'Fix all',
            'wp-cleanfix'
          ); ?>
        </button>
  ...
  {
    echo wp_kses_post($this->toolBar);
  }

  public function addMetaBox()
  {
    add_meta_box(
      sanitize_title(get_called_class()),

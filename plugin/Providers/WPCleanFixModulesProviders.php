...
class WPCleanFixModulesProviders extends ServiceProvider
{
  ...
  {
    $clean    = '<a href="' . menu_page_url( 'wp_cleanfix_slug_menu', false ) . '">' . __( 'Clean & Fix', 'wp-cleanfix' ) . '</a>';
    $settings = '<a href="' . menu_page_url( 'wpcleanfix_settings', false ) . '">' . __( 'Settings', 'wp-cleanfix' ) . '</a>';
